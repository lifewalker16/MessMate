...
export default function ExpensesScreen() {
  ...
  const fetchExpenses = async () => {
    ...
    try {
      const res = await fetch(`https://messmate-2xh8.onrender.com/expense/total/${userId}?period=${selectedPeriod}`, {
  ...
  const addExtraItem = async () => {
    ...
    try {
      const res = await fetch(`https://messmate-2xh8.onrender.com/expense/add`, {
        method: 'POST',
