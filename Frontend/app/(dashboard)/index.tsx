        ...
        const markMeal = async (meal: "breakfast" | "lunch" | "dinner") => {
          ...
          const totalAmount = mealItems[meal].reduce((sum, item) => sum + Number(item.price), 0);
           ...
           // const totalAmount = mealItems[meal].reduce((sum, item) => sum + item.price, 0);
            ...
            const response = await fetch(
              "https://messmate-2xh8.onrender.com/dashboard/attendance/mark",
              {
                method: "POST", 
                headers: {
          ...
          useEffect(() => {
            const fetchUser = async () => {
              try {
                ...
                const response = await fetch("https://messmate-2xh8.onrender.com/profile", {
          ...
          useEffect(() => {
            const fetchAttendance = async () => {
              ...
              try {
                const response = await fetch(
                  "https://messmate-2xh8.onrender.com/dashboard/attendance/today",
                  {
                    headers: { Authorization: `Bearer ${token}` },
                  }
                );
            ...
            //fetch announcement
              useEffect(() => {
                const fetchAnnouncements = async () => {
                  try {
                    const response = await fetch("https://messmate-2xh8.onrender.com/announcements");
                    const data = await response.json();
          ...
          // ✅ Fetch expense summary
            const fetchExpenseSummary = async () => {
              try {
                ...
                const response = await fetch(
                  `https://messmate-2xh8.onrender.com/expense/summary/${user.id}`,
                  {
                    headers: {
                      Authorization: `Bearer ${token}`,
                    },
          ...
          // ✅ Fetch weekly data
            const fetchWeekly = async () => {
              ...
              try {
                const response = await fetch(
                  "https://messmate-2xh8.onrender.com/dashboard/weekly-attendance",
                  {
                    headers: { Authorization: `Bearer ${token}` },
                  }
                );
          ...
          const fetchTodayMeals = async () => {
            ...
            try {
              const response = await fetch("https://messmate-2xh8.onrender.com/dashboard/today-meal", {
                headers: { Authorization: `Bearer ${token}` },
              });
              const data = await response.json();
              if (response.ok) {
